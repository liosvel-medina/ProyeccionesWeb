...
export let scheduleData: Object[] = [
  {
    ...
    EndTime: new Date(2021, 1, 11, 11, 0),
    CategoryColor: '#1aaa55'
  }, {
    Id: 2,
    ...
    EndTime: new Date(2021, 1, 19, 13, 0),
    CategoryColor: '#7fa900'
  }, {
    Id: 10,
    ...
    Id: 16,
    Subject: 'Sky Gazers',
    StartTime: new Date(2021, 1, 23, 11, 0),
    EndTime: new Date(2021, 1, 23, 13, 0),
    CategoryColor: '#ea7a57'
  }, {
    Id: 17,
    Subject: 'The Cycle of Seasons',
    StartTime: new Date(2021, 1, 12, 5, 30),
    EndTime: new Date(2021, 1, 12, 7, 30),
    CategoryColor: '#00bdae'
  }, {
    Id: 18,
    Subject: 'Space Galaxies and Planets',
    StartTime: new Date(2021, 1, 12, 17, 0),
    EndTime: new Date(2021, 1, 12, 18, 30),
    CategoryColor: '#f57f17'
  }, {
    Id: 19,
    Subject: 'Lifecycle of Bumblebee',
    StartTime: new Date(2021, 1, 15, 6, 0),
    EndTime: new Date(2021, 1, 15, 7, 30),
    CategoryColor: '#7fa900'
  }, {
    Id: 20,
    Subject: 'Sky Gazers',
    StartTime: new Date(2021, 1, 15, 16, 0),
    EndTime: new Date(2021, 1, 15, 18, 0),
    CategoryColor: '#ea7a57'
  }
];
...
export let resourceData: Object[] = [
  {
    ...
    EndTime: new Date(2021, 3, 4, 13, 30),
    IsAllDay: false,
    OwnerId: 1,
    RoomId: 1
  }, {
    ...
    Id: 44,
    Subject: 'Resource planning',
    StartTime: new Date(2021, 3, 22, 13),
    EndTime: new Date(2021, 3, 22, 14, 30),
    IsAllDay: false,
    OwnerId: 2,
    RoomId: 2
  }, {
    Id: 45,
    Subject: 'Timeline estimation',
    StartTime: new Date(2021, 3, 23, 9),
    EndTime: new Date(2021, 3, 23, 10),
    IsAllDay: false,
    OwnerId: 3,
    RoomId: 1
  }, {
    Id: 46,
    Subject: 'Developers Meeting',
    StartTime: new Date(2021, 3, 23, 14),
    ...
    Id: 47,
    Subject: 'Project Review',
    StartTime: new Date(2021, 3, 24, 11),
    EndTime: new Date(2021, 3, 24, 12),
    IsAllDay: false,
    OwnerId: 1,
    RoomId: 1
  }, {
    Id: 48,
    Subject: 'Manual testing',
    StartTime: new Date(2021, 3, 24, 9),
    EndTime: new Date(2021, 3, 24, 11, 30),
    IsAllDay: false,
    OwnerId: 2,
    RoomId: 2
  }, {
    Id: 49,
    Subject: 'Project Preview',
    StartTime: new Date(2021, 3, 25, 9, 30),
    EndTime: new Date(2021, 3, 25, 11),
    IsAllDay: false,
    OwnerId: 3,
    RoomId: 1
  }, {
...
export let roomData: Object[] = [
  ...
  },
  {
    ...
    EndTime: new Date(2021, 7, 1, 18, 0),
    RoomId: 10
  },
  {
    Id: 25,
...

  {
    ...
    Subject: 'Board Meeting',
    Description: 'Meeting to discuss business goal of 2018.',
    StartTime: new Date(2021, 7, 1, 9, 0),
    EndTime: new Date(2021, 7, 1, 11, 0),
    RoomId: 1
  },
  {
    Id: 29,
    Subject: 'Training session on JSP',
    Description: 'Knowledge sharing on JSP topics.',
    StartTime: new Date(2021, 7, 1, 17, 0),
    EndTime: new Date(2021, 7, 1, 20, 0),
    RoomId: 6
  },
  {
    Id: 30,
    Subject: 'Sprint Planning with Team members',
    Description: 'Planning tasks for sprint.',
    StartTime: new Date(2021, 7, 1, 10, 30),
  ...
  },
  {
    ...
    Subject: 'Training session on C#',
    Description: 'Training session',
    StartTime: new Date(2021, 7, 1, 14, 30),
    EndTime: new Date(2021, 7, 1, 16, 0),
    RoomId: 2
  },
  {
    Id: 34,
    ...
    Description: 'Meeting to discuss client requirements.',
    StartTime: new Date(2021, 7, 1, 10, 30),
    EndTime: new Date(2021, 7, 1, 13, 0),
    RoomId: 3
  },
  {
    Id: 35,
    Subject: 'Appraisal Meeting',
    Description: 'Meeting to discuss employee appraisals.',
    StartTime: new Date(2021, 7, 1, 15, 0),
    EndTime: new Date(2021, 7, 1, 16, 30),
    RoomId: 8
  },
  {
    Id: 36,
    ...
    EndTime: new Date(2021, 7, 1, 11, 30),
    RoomId: 4
  },
  {
    Id: 37,
    Subject: 'Customer Meeting',
    Description: 'Meeting to discuss customer reported issues.',
    StartTime: new Date(2021, 7, 1, 10, 0),
    EndTime: new Date(2021, 7, 1, 12, 0),
    RoomId: 9
  },
  {
    ...
    Description: 'Meeting to discuss business plans.',
    StartTime: new Date(2021, 7, 1, 15, 0),
    EndTime: new Date(2021, 7, 1, 17, 0),
    RoomId: 4
  },
  {
    Id: 39,
    ...
    Description: 'Knowledge sharing on Vue concepts.',
    StartTime: new Date(2021, 7, 1, 9, 0),
    EndTime: new Date(2021, 7, 1, 10, 30),
    RoomId: 5
  },
  {
    Id: 40,
    Subject: 'Meeting with Team members',
    Description: 'Meeting to discuss on work report.',
    StartTime: new Date(2021, 7, 1, 11, 30),
    EndTime: new Date(2021, 7, 1, 12, 30),
    RoomId: 5
  },
  {
    Id: 41,
    Subject: 'Meeting with General Manager',
    Description: 'Meeting to discuss support plan.',
    StartTime: new Date(2021, 7, 1, 14, 0),
    EndTime: new Date(2021, 7, 1, 16, 0),
    RoomId: 10
  },
  {
    ...
    Subject: 'HR Meeting',
    Description: 'Meeting to discuss HR plans.',
    StartTime: new Date(2021, 7, 1, 18, 0),
    EndTime: new Date(2021, 7, 1, 20, 0),
    RoomId: 2
  },
  {
    ...
    Subject: 'HR Meeting',
    Description: 'Meeting to discuss HR plans.',
    StartTime: new Date(2021, 7, 1, 17, 30),
    EndTime: new Date(2021, 7, 1, 20, 0),
    RoomId: 1
  },
  {
  ...
  },
  {
    ...
    Subject: 'Board Meeting',
    Description: 'Meeting to discuss business plans.',
    StartTime: new Date(2021, 7, 1, 18, 30),
    EndTime: new Date(2021, 7, 1, 20, 0),
    RoomId: 4
  },
  {
    ...
    Subject: 'Board Meeting',
    Description: 'Meeting to discuss business plans.',
    StartTime: new Date(2021, 7, 1, 15, 30),
    EndTime: new Date(2021, 7, 1, 18, 0),
    RoomId: 5
  },
  {
  ...
  },
  {
    ...
    Description: 'Meeting to discuss employee appraisals.',
    StartTime: new Date(2021, 7, 1, 18, 0),
    EndTime: new Date(2021, 7, 1, 19, 30),
    RoomId: 7
  },
  {
    Id: 53,
